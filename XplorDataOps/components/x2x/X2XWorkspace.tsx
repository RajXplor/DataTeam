        ...
        <div className="card p-5 fade-in-up">
          ...
          <div className="grid sm:grid-cols-2 gap-5 mb-4">
            ...
            <div>
              ...
              />
              <PathHint text="Profiles > Children > Filter Active + Waitlist > Export > Master CSV" />
              <ScreenshotPlaceholder
                src="/children-master-export.png"
                alt="Screenshot: how to export the Children Data Master from Xplor"
                onOpen={() => setActiveImage('/children-master-export.png')}
              />
            </div>
